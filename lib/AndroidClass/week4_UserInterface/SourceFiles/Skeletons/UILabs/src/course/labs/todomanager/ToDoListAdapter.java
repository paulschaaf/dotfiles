...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//T_ODO - Get the current ToDoItem
		final ToDoItem toDoItem = mItems.get(position);

		//T_ODO - Inflate the View for this ToDoItem
		// from todo_item.xml.
		View itemView = LayoutInflater.from(mContext).inflate(R.layout.todo_item, null);
		
		//T_ODO - Fill in specific ToDoItem data
		// Remember that the data that goes in this View
		// corresponds to the user interface elements defined 
		// in the layout file 

		//T_ODO - Display Title in TextView

		final TextView titleView = (TextView) itemView.findViewById(R.id.titleView);
		titleView.setText(toDoItem.getTitle());
		
		// T_ODO - Set up Status CheckBox
		...
		//T_ODO - Display Priority in a TextView
