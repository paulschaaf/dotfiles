...
object Euler_11 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(117); 
...
};System.out.println("""time: (f: => Unit)Unit""");$skip(694); 
/*
...
};System.out.println("""toBinary: (i: Int, digits: Int)java.lang.String""");$skip(717); 

def twoToThe(exp: Int) = BigInt(1) << exp;System.out.println("""twoToThe: (exp: Int)scala.math.BigInt""");$skip(866); 
...
};System.out.println("""sumOfPrimesBelow: (cutoff: Int)BigInt""");$skip(47); 

//sumOfPrimesBelow(10)

val before = new Date;System.out.println("""before  : java.util.Date = """ + $show(before ));$skip(37); val res$0 = 
...
*/
type Grid = List[List[Int]];System.out.println("""res0: java.util.Date = """ + $show(res$0));$skip(3412); 
...
);System.out.println("""bigGrid  : List[List[Int]] = """ + $show(bigGrid ));$skip(26); 

val littleDimensions = 7;System.out.println("""littleDimensions  : Int = """ + $show(littleDimensions ));$skip(92); 
val littleGrid = bigGrid.take(littleDimensions).
												 map(_.take(littleDimensions));System.out.println("""littleGrid  : List[List[Int]] = """ + $show(littleGrid ));$skip(879); 
def grid4TuplesList(aGrid: Grid): List[List[Int]] = {
	...
	recurseGrid(aGrid)
};System.out.println("""grid4TuplesList: (aGrid: Euler_11.Grid)List[List[Int]]""");$skip(898); 
...
def grid4TuplesStream(aGrid: Grid): Stream[List[Int]] = {
	...
	recurseGrid(aGrid)
};System.out.println("""grid4TuplesStream: (aGrid: Euler_11.Grid)Stream[List[Int]]""");$skip(41); 

val tuples = grid4TuplesStream(bigGrid);System.out.println("""tuples  : Stream[List[Int]] = """ + $show(tuples ));$skip(120); 
...
// Alternative implementation found online
    ...
    };System.out.println("""toLine: (x: Int, y: Int, dirX: Int, dirY: Int)Option[scala.collection.immutable.IndexedSeq[Int]]""");$skip(274); 
...
/*	@tailrec
	...
	*/
	...
	null
};System.out.println("""primeNumbersUpTo: (limit: Double)Euler_11.BitMap""");$skip(141); 
val triangle = {
	...
	tri(1, 0)
};System.out.println("""triangle  : Stream[Int] = """ + $show(triangle ));$skip(31); 

def tau(n: Int): Int = {4
	
};System.out.println("""tau: (n: Int)Int""");$skip(4); val res$1 = 


1;System.out.println("""res1: Int(1) = """ + $show(res$1))}
}