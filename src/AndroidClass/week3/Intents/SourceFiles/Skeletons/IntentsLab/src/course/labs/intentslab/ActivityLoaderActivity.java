...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// T_ODO - Create a new intent to launch the ExplicitlyLoadedActivity class
		Intent intent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		
		// T_ODO - Start an Activity using that intent and the request code defined above
	...
	private void startImplicitActivation() {
		...
		// T_ODO - Create a base intent for viewing a URL 
		// (HINT:  second parameter uses parse() from the Uri class)
		Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		
		// T_ODO - Create a chooser intent, for choosing which Activity
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// T_ODO - Process the result only if this method received both a
